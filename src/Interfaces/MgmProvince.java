    ...
    public void Update() {
        ...
        try {
            ...
            if (x == 0) {
                ...
                Connection c = DB.mycon();
                Statement s = c.createStatement();
                s.executeUpdate("UPDATE province SET Province_Name = '" + txtName.getText() + "' where Province_Name = '" + txtName.getText() + "' ");
...
//====================================================================Search()==
    public void Search() {
        try {
            ...
            Connection c = DB.mycon();
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM province WHERE Province_Name = '" + txtName.getText() + "'");
